            ...
            <div className="empty__bar">
                ...
                <div className="filter__bottom">
                        <div className="prices">
                            ...
                            <span className="min__price t-18 mb-0">${Utils.formatNumber(this.state.minPrice)}</span>
                            <span className="min__price t-18 mb-0"> - </span>
                            <span className="max__price t-18 mb-0">${Utils.formatNumber(this.state.maxPrice)}</span>
                        </div>
                </div>
            </div>
